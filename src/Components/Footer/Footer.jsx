        ...
        <footer id='footer' className='text-white' style={{ backgroundColor: '#123F1E' }}>
                ...
                <div className='grid md:grid-cols-4 lg:grid-cols-5 sm:grid-cols-4 grid-cols-2 sm:gap-x-2 lg:gap-x-0 gap-x-1.5 sm:gap-y-9 lg:gap-y-0 gap-y-7 '>
                    ...
                    <div className='lg:col-auto md:col sm:col-span-3 col xl:space-y-3.5 space-y-2'>
                        ...
                        <div className='sm:space-y-2 space-y-1.5 xl:text-base text-sm'>
                            {/* Phone (fake) */}
                            <a className='block text-sm sm:text-base hover:underline' href="tel:+2 (408) 896-0127">
                                <Phone fontSize='inherit' /> +2 (408) 896-0127
                            </a>

                            {/* Email */}
                            <a className='block text-sm sm:text-base hover:underline' href="shimaamoh708@gmail.com">
                                <Mail fontSize='inherit' /> shimaa@gmail.com
                            </a>

                            {/* Address (fake)*/}
                            <address>
                                <LocationOn fontSize='inherit' />123 Main Street, Egypt
                            </address>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div className='text-center flex items-center h-12'>
                    <span className='text-xs  w-full block text-gray-300 tracking-wider'>© 2025 Developed By <a className='hover:underline' href="https://github.com/Shimaa-Es" target="_blank" rel="noopener noreferrer"> Shimaa<span style={{ color: 'green' }}>💚</span></a></span>
                </div>
            </div>
        </footer>
    );
